    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Borrowers", x => x.Card);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAuthors", x => new { x.PublicationId, x.AuthorId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BookAuthors_Publications_PublicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryKard = table.Column<int>(nullable: false),
                    BorrowerCard = table.Column<int>(nullable: true),
                    BookId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rents_Borrowers_BorrowerCard",
                        column: x => x.BorrowerCard,
